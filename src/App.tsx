            ...
            {view === "home" && (
              <div className="relative flex flex-col w-full">
                ...
                <div className="relative min-h-screen flex flex-col justify-center px-6 overflow-hidden">
                  ...
                  <div className="max-w-[1800px] mx-auto w-full relative z-20 pt-32 pb-24 px-6 md:px-12 min-h-[90vh] flex flex-col justify-center">
                    <motion.div
                      ...
                      className="relative"
                    >
                      <div className="w-16 h-px bg-zinc-900 mb-8 md:mb-12"></div>

                      <h1
                        className="font-display font-medium leading-[0.9] tracking-tight mb-8 md:mb-12 text-zinc-900 max-w-5xl text-pretty"
                        style={{ fontSize: "clamp(3rem, 7vw, 7rem)" }}
                      >
                        <TextReveal>The New Standard for</TextReveal>
                      ...
                      <div className="flex flex-col md:flex-row gap-8 items-start md:items-center relative z-30">
                        <button
                          onClick={() => setView("generator")}
                          className="group relative inline-flex items-center gap-4 px-8 py-4 md:px-10 md:py-5 bg-zinc-900 text-[#F4F4F0] overflow-hidden transition-all hover:bg-primary rounded-full shadow-2xl"
                        >
                ...
                <div className="w-full bg-[#EAEAE5] px-6 py-32">
                  <div className="max-w-[1800px] mx-auto">
                    <h2 className="text-4xl md:text-5xl font-display font-medium text-center mb-24 text-primary text-pretty tracking-tight">
                      Elevate Your Proposals with Clear Visualization.
                    </h2>
                ...
                <div className="w-full bg-white px-6 py-32">
                  <div className="max-w-[1200px] mx-auto text-center space-y-12">
                    ...
                    <div className="aspect-video">
                      <ComparisonSlider
                        beforeImage="https://www.bhg.com/thmb/XnofJpnpGWEE8gVua1Dt_h75xv4=/750x0/filters:no_upscale():max_bytes(150000):strip_icc()/BHG-English-Garden-Design-101648946-a0b7597b18154b9b9b8e3c8a7873d50d.jpg"
                ...
                <div className="w-full bg-[#F4F4F0] px-6 py-32 border-b border-primary/10">
                  <div className="max-w-4xl mx-auto text-center space-y-8">
                    ...
                    <h2 className="text-5xl md:text-7xl font-display text-primary text-pretty tracking-tight">
                      See the Future of Your Landscape Before Breaking Ground.
                    </h2>
                  </div>
                </div>
                  ...
                  <div className="max-w-[1800px] mx-auto">
                    <div className="grid md:grid-cols-2 gap-16 items-center">
                      ...
                      <div className="aspect-square bg-zinc-100 rounded-2xl overflow-hidden relative group cursor-pointer">
                        <img
                          src="https://snipboard.io/wXfPAV.jpg"
                          alt="Services"
                          className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105 filter grayscale group-hover:grayscale-0"
                        />
                        <div className="absolute inset-0 bg-black/0 group-hover:bg-black/10 transition-colors" />
